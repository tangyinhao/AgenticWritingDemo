...
def main():
    ...
    parser.add_argument("--outline", help="大纲 Markdown 文件路径（含 #/##/### 和 <tag>...）", default="留空补全/0/outline.md")
    parser.add_argument("--original", help="原文 Markdown 文件路径", default="留空补全/0/full_content.md")
    parser.add_argument("--output", help="输出 JSON 文件路径（缺省则打印到 stdout）", default="留空补全/0/section_content.md")
